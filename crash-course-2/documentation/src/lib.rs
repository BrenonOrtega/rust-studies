...
//! though it does not possess a scientific definition and may be used in reference to many different squashes of
//! varied appearance.
//! ![pumpkim-image](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)

/// Represents the punkim 
pub struct Pumpkin {
    pub roundness: f32,
    pub orangeness: i32,
}
...
impl Pumpkin {
    /// Smashing the pumpkim will consume it entirely.
    pub fn smash(self) {}
}
...
/// Describes the maximum orangeness of a pumpikm in the struct [`Pumpkin`]
...
/// To make this appear use the command `cargo doc --no-deps --open --document-private-items`
...
enum PrivateEnum {
    /// Very nice to eat, good for cutting phases.
    VapormadePumpkimCubes,
